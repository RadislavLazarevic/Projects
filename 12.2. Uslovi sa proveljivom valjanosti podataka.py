...
while data_valid == False:
    ...
    if absences < 0 or absences > total_classes:
        print("The number of absences can't be less then zero or greater then number of total classe")
        continue
    else:
        data_valid = True
...
if(avg_grade >= 6 and attendance >= 0.8):
    ...
    print("The student has faile due to attendace rate lower than 80%. ")
